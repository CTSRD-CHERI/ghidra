...
public enum AARCH64_ElfRelocationType implements ElfRelocationType {
	...
	//// Morello relocations
	R_MORELLO_CAPINIT(59392),       // XXXR3: explain capdesc.
	R_MORELLO_GLOB_DAT(59393),      // Create GOT entry.
	R_MORELLO_JUMP_SLOT(59394),     // Create PLT entry.
	R_MORELLO_RELATIVE(59395),      // Adjust by program base.
	R_MORELLO_IRELATIVE(59396),
	R_MORELLO_TLSDESC(59397),
	R_MORELLO_TPREL128(59398);
