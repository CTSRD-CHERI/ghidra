...
public class MorelloSymbolAnalyzer extends AbstractAnalyzer {

	private final static String NAME = "Morello Function Symbol Analyzer";
	private final static String DESCRIPTION =
		"Analyze bytes for Morello symbols and shift -1 as necessary (hack before the complete purecap ABI).";

	public MorelloSymbolAnalyzer() {
	...
	public boolean added(Program program, AddressSetView set, TaskMonitor monitor, MessageLog log) {
		monitor.setMessage("Morello C64/A64 symbol analyzer (hack before the complete purecap ABI)");
		...
		while (it.hasNext() && !monitor.isCancelled()) {
			...
			// Check if LSB is set to indicate C64 instruction set
