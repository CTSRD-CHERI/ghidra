...

{
  ...
  act->addAction( new ActionFuncLinkOutOnly("noproto") );
  {
    ...
    ActionPool *actprop_special1 = new ActionPool(Action::rule_repeatapply,"special1");
    ActionPool *actprop_special2 = new ActionPool(Action::rule_repeatapply,"special2");
    actprop_special1->addRule( new RuleCollapseConstants("analysis") );
    actprop_special2->addRule( new RuleVarArgsConv("analysis") );
    actmainloop->addAction( actprop_special1 );
    actmainloop->addAction( actprop_special2 );
